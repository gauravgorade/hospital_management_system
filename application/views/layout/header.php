<header class="header-area">
    <div class="header-top second-header d-none d-md-block"
        style="background: transparent linear-gradient(90deg, #235caa 0%, #c52372 100%) 0% 0% no-repeat padding-box;">
        <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="main-menu text-right pr-15">
                            <nav id="mobile-menu">                                
                                <ul>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>">Home</a></li>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>about-us">About Us</a></li>
                                    <li class="has-sub navbg">
                                        <a href="javascript:void(0);">Speciality</a>
                                        <ul>
                                            <li class="navbg"><a href="<?php echo base_url(); ?>skin">Skin Speciality</a></li>
                                            <li class="navbg"><a
                                                    href="<?php echo base_url(); ?>endovascular">Endovascular Speciality</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>contact-us">Contact</a></li>
                    ...
                    <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                        <a href="#mainenquiry" data-toggle="modal" class="top-btn appointmentbtn fw"> Enquire Now <i
                ...
                <div class="form-group text-center pb-2 mt34">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input name="yname" type="text" class="form-control" id="yname" class="form-control" placeholder="Name"
                                required>
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <select name="servicesname" id="hospitaltreatment" class="form-control mb-1 select" required>
