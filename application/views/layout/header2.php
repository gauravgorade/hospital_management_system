                ...
                <div class="col-lg-6 col-md-3 d-none d-lg-block">
                    <div class="header-social text-right">
                        <span>
                            ...
                            <a target="_blank" href="https://www.instagram.com/jajuendovascularclinic/"
                                title="Instagram"><i class="fab fa-instagram"></i></a>
                            <a href="javascript:void(0);" title="Youtube"><i class="fab fa-youtube"></i></a>
                            <a target="_blank" href="https://www.google.com/maps/place/Jaju+Clinic/@19.859294,75.347471,14z/data=!4m5!3m4!1s0x0:0x52e59df451bc8466!8m2!3d19.8592556!4d75.3474678?hl=en" title="Youtube"><i class="fa fa-map-marker"></i></a>
                        </span>
                    </div>
                </div>   
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="main-menu text-right pr-15">
                            <nav id="mobile-menu">
                                <ul>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>skin">Skin</a></li>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>skin/treatment">Services</a></li>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>skin/gallery">Gallery</a></li>
                                    <li class="navbg"><a href="<?php echo base_url(); ?>skin-blogs">Blog</a></li>
                                    <li id="appo" class="appobg">
                                        <a href="#enquiry" data-toggle="modal" class="top-btn fw "> Enquire Now <i class="fas fa-chevron-right"></i></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content form-wrapper">
            ...
            <div class="container-fluid mt-5" style="background-color:#fff; ">
                ...
                <?php  echo form_open_multipart('Book_appointment/homeshortappointment' ,'class="contact-form needs-validation" id="SkinEnquiry" novalidate'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input type="hidden" name="servicesname" id="hospitaltreatment" class="form-control" value="Skin Speciality" required>
                    </div>
                   <center>
                   <div class="slider-btn mb-20" >
