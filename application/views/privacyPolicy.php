...
<?php   $this->load->view('layout/style');   ?>
    ...
    <title> JAJU – PRIVACY POLICY | Hospital and Health </title>
...
<?php  
    ...
    <main>
        ...
        <section class="container">
            <h2 class="DisclaimerHead">Privacy Policy</h2>

            <p>At jajuclinic, accessible from <a target="_blank" href="https://jajuclinic.com/">jajuclinic.com</a>, one of our main
                priorities is the privacy of our visitors. This Privacy Policy document contains types of information
                that is collected and recorded by jajuclinic and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in jajuclinic. This policy is not applicable
...
<br>
            ...
            <p>jajuclinic follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of jajuclinic.
            </p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on jajuclinic, which are sent directly to
            ...
            <p>Note that jajuclinic has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h4>Third Party Privacy Policies</h4>

            <p>jajuclinic's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>jajuclinic does not knowingly collect any Personal Identifiable Information from children under the age
