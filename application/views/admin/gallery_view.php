...
<?php   $this->load->view('admin/file/header')?>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>gallery/view_gallery">View Skin Gallery</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title"> Our Skin Gallery </h6>
                            <div class="table-responsive">
                                 ...
                                 <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->g_id;  $status = $row->status;  ?>
				 			    <tr>
                                        
                                        
                                        <th align="center">   
											<img src="<?php echo  base_url()."public/img/gallery/".$row->img_path;?>"  style="width: 150px; height: 150px;" alt="image">   
                                         </th>
                                        <td> <?php echo $row->name; ?></td>
                                         <th><a href="<?php echo base_url()."Gallery/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."Gallery/delete_gallery/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
