        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">SEO Add</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Crete New On Page SEO </h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('Seo/create_seo' ,'class="needs-validation" novalidate'); ?>
   ...
   <div class="form-row">
      ...
      <div class="col-md-6 mb-3">
         ...
         <input name="page_name" id="page_name"  type="text" class="form-control" required>
         <div class="invalid-tooltip">   Please Enter Page Name.  </div>
      </div>
       <div class="col-md-6 mb-3">
         <label for="service_url">Page Url</label>
         <input name="page_url" id="page_url"  type="text" class="form-control" required>
      ...
      <div data-label="CODE EXAMPLE" class="demo-code-preview col-md-12">
