        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
  				   <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Customer Details Export </h6>
                            
                           <?php  echo form_open_multipart('Customer/export'); ?>
     ...
     <br>  <br>
       ...
       ?>
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->pri." ".$row->name." ".$row->last_name; ?></td>
                                        <td> <?php echo $row->mobile; ?> , <?php echo $row->mobile2; ?> </td>
                                        <td> <?php echo $row->email; ?></td>
                                         <td> <?php echo $row->address; ?></td>
                                      	 <td> <?php echo $row->city; ?></td>
                                      	 <td> <?php echo $row->pan_no; ?></td>
                                      	 <td> <?php echo $row->gstnid; ?></td>
