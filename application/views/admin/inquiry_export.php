...
<?php   $this->load->view('admin/file/header')?>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
  				   <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Appointment Inquiry   </h6>
   ...
   <div class="invalid-tooltip">   Please Enter Password.  </div>
     ...
     <?php  echo form_close();?>
     <br>  <br>
       <h6 class="card-title">Appointment Inquiry Export  
       ...
       ?>
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->service; ?></td>
                                         ...
                                         <td>  <?php echo date("d-M-Y",strtotime($row->ap_date)).' at '.date("h:i: A",strtotime($row->time));?></td>
