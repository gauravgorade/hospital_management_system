...
<div class="row">
 ...
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
	 ...
	 <div class="col-md-6 mb-3">
	   ...
	   <div class="col-md-6 mb-3">
		...
		<option  value="">Select</option>
		   <option  value="1,2">ALL</option>
     	    <option  value="1">Indo Vascular</option>
			<option  value="2">Skin Treatement</option>
	   ...
	   <div class="col-md-6 mb-3">
               <label for="admin_def_role">Set Default Admin Role</label>
          <select name="admin_def_role" id="admin_def_role" required class="form-control" required>
			<option  value="">Select</option>
     	    <option  value="1">Indo Vascular</option>
			<option  value="2">Skin Treatement</option>     
  	  </select>
