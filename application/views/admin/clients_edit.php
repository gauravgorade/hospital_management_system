        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Clients/view_Clients">Clients View</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Clients Update</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Update Client</h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('Clients/update_clients' ,'class="needs-validation" novalidate'); ?>
   ...
   <div class="form-row">
      <div class="col-md-12 mb-3">
       ...
       <input type="hidden"   name="url" value="<?php echo base_url().$this->uri->uri_string();?>">
         ...
         <input name="cname" id="cname" value="<?php echo $row->cname?>"  type="text" class="form-control" 
              required>
     ...
     <div class="col-md-12" style="padding: 20px;">
      <div class="row">
       <div class="col-md-8">
       <label for="userImage">Select Client Image <code> Height= 100px and width= 140px;
 		 	   </code></label>
