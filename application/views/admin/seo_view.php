        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Crelite Seo Pages List </h6>
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->page_name ?>  </td>
                                         ...
                                         <td> <?php echo $row->page_url ?>  </td>
                                             ...
                                             <td> 
                                             <a href="<?php echo base_url()."Seo/edit_seo/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
               							
                                            <a  title="Delete" href="<?php echo base_url()."Seo/seo_delete/".$t_id;?>" 
  											class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
                                            
               								 </td>
               								 <td> <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Seo/seo_status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   							<a href="<?php echo base_url()."Seo/seo_status/".$t_id."/1";?>">
