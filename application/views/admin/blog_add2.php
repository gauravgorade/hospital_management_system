...
<head>
    ...
    <title> Edit Endovascular Blog</title>
                ...
                <div class="content ">
                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Endovascular Blog Edit</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php  echo form_open_multipart('blogs2/creating_blog' ,'class="needs-validation" novalidate'); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="invalid-tooltip"> Please Enter Blog Url Permalink. </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 ">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="short_desc" id="short_desc"
                                                            rows="2" value="" required  minlength="100" maxlength="1000"></textarea>
												 <div class="invalid-tooltip"> Please Enter Blog Short Description. </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input name="featured" type="checkbox" class="custom-control-input"  id="customSwitch1" >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <img id="prelg_profile"
                                                                src="<?php echo base_url()."public/img/client/dumy_logo.png";?>"
                                        ...
                                        <div class="card-body text-center">
                                      		 <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <img src="<?php echo base_url()?>public/img/client/dumy_logo.png"
