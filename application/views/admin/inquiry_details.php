...
<head>
    ...
    <title>Appointment Inquiry Details</title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Appointment Inquiry Details</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 ...
                 Appointment Inquiry List </a>
                    </li>
                    <li class="breadcrumb-item active">
                        <a href="#"> 
 						Appointment Inquiry Full Details </a>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h6 class="card-title mb-2">Appointment Inquiry Details</h6>
   ...
   -->  
                       ...
                       <!--       <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                                    <h5>Appointment Request For Date </h5>
                                     
                                </div>
                                <div class="col-md-10 col-12">
                                    <h3 class="text-info mb-0 float-right"> 
                                    <?php   
                                    echo date("d-M-Y",strtotime($row->ap_date)).' at '.date("h:i: A",strtotime($row->time));?> </h3>
                                </div>
                            </div> -->
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                                    <h5>Requesting for Tretment</h5>
                                     
                                </div>
                                <div class="col-md-10 col-12">
                                    <h3 class="text-primary mb-0 float-right"> 
                         ...
                         <!--    <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <div class="col-md-10 col-12">
                                <h3 class="text-success mb-0 float-right"> <?php echo $row->age; ?></h3>
                            	</div>
                            </div> --> 
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                                ...
                                <div class="col-md-10 col-12">
                                    <h3 class="text-secondary mb-0 float-right"><?php echo $row->city; ?></h3>
                                </div>
                            </div>
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
