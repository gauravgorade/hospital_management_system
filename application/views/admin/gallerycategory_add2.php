...
<html lang="en">
 <head>
    ...
    <title> Endovascular -  Gallery Category</title>
...
<div class="layout-wrapper">
  ...
  <?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Endovascular - Gallery Category </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Gallery Category Add</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title"> Endovascular -Gallery Category </h6>
