            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>blogs/view">View  Skin Blogs</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">View  Skin Blogs  </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->blog_name; ?></td>
										  ...
										  <td> <a href="<?php echo base_url()."blogs/comment/".$t_id;?>" type="button" class="btn btn-primary btn-sm  position-relative"> 
											CMNT (<?php    $query = $this->db->query("SELECT * FROM blog_camment where blog_id='$t_id'" );
												echo $query->num_rows(); ?>)
										     <span class="badge bg-danger ms-2">
												NEW <?php  	$query = $this->db->query("SELECT * FROM blog_camment where blog_id='$t_id' AND status='1'" );
												echo $query->num_rows(); 	?>
											 </span> </a>
											  
									  </td>
                                         <th class="text-center"><a href="<?php echo base_url()."blogs/edit/".$t_id;?>" class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."blogs/delete/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
