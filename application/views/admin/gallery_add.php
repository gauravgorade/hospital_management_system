        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Gallery/view_gallery">Skin Gallery View</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Skin Gallery Add</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Add Skin Gallery</h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('Gallery/creting_gallery' ,'class="needs-validation" novalidate'); ?>
   ...
   <div class="form-row">
     ...
     <div class="col-md-12" style="padding: 20px;">
      ...
      <?php
      $result_ser=  $this->gallery_model->get_activecatigiry();
      ...
      <?php } ?>
       ...
       <div class="col-md-4">
       	<img src="<?php echo base_url()?>public/img/client/dumy_logo.png" id="pre_profile" 
