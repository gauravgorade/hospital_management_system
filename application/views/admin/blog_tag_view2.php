...
<head>
    ...
    <title>View Endovascular Blog Tag </title>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <a href="<?php echo base_url();?>blogs2/view_blog_tag">View Endovascular Blog Category</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Add Endovascular Blog Tag</h6>
                                            <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->


                                            <?php  echo form_open_multipart('Blogs2/creating_blog_tag' ,'class="needs-validation" novalidate'); ?>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Endovascular  Blog Tags</h6>
                                    	 ...
                                    	 $t_id = $row->b_tag_id;  $status = $row->b_tag_status; 
                                    	    ...
                                    	    ?>
                                                        <tr>
                                                            ...
                                                            <th  width="8%" class="text-center"><a href="<?php echo base_url()."Blogs2/edit_blog_tag/".$t_id;?>"
                                                                    class="btn btn-primary btn-floating btn-sm">
                                                                    <i class="ti-pencil-alt"></i></a>
                                                                <a href="<?php echo base_url()."Blogs2/delete_blogtag/".$t_id;?>"
                                                            ...
                                                            <td  width="5%">
                                                                <?php if ($status == 1){ ?>
                                                                <a
                                                                    href="<?php echo base_url()."Blogs2/blogtag_status/".$t_id."/0"?>">
                                                                    <span class="badge badge-success">Active</span></a>
                                                                <?php } else {?>
                                                                <a
                                                                    href="<?php echo base_url()."Blogs2/blogtag_status/".$t_id."/1";?>">
