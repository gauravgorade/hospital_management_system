...
<head>
    ...
    <title>View Skin  Blog Category </title>
                ...
                <div class="content ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
							<h6 class="card-title">Add Skin  Blog Category</h6>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">Skin  Blog Categories</h6>
                                    	 ...
                                    	 $i++;
                                    	    ...
                                    	    ?>
                                                <tr>
                                                    ...
                                                    <th><a href="<?php echo base_url()."Blogs/edit_blog_categories/".$t_id;?>"
