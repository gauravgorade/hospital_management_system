        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>review/view_review">Review View</a>
                    </li>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Review & Success story</h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('review/creting_review' ,'class="needs-validation" novalidate'); ?>
   ...
   <div class="form-row">
      ...
      <div class="col-md-6 mb-3">
         <label for="cname">Company name with designation And City</label>
         ...
         <input name="rating" id="rating"  type="number" min="1" max="5" maxlength="1" class="form-control" 
            placeholder="Star Rating" required >
         <div class="invalid-tooltip">  Please Enter Star Rating 1 to 5 only. </div>
      </div>
	    <div class="col-md-6 mb-3">
      ...
      <div class="col-md-12">
         <label for="thought">Thought / Story </label>
           <textarea name="thought" id="thought"  class="form-control"
        	  ...
        	  <div class="invalid-tooltip">   Please provide a Thought or Story
        	 </div>
      </div>
