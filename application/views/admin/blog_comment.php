            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>blogs/view">View  Comments Blogs</a>
                    </li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
										...
										<td> <?php echo substr($row->email,0, 10);?> </td> 
                                         ...
                                         <th class="text-center"><a href="<?php echo base_url()."blogs/comments_view/".$t_id."/".$blog_id;?>" class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."blogs/cmt_delete/".$t_id."/".$blog_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
