        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Job Application View </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                       ...
                                       ?></td>
                                      <th><a  title="View Details" href="<?php echo base_url()."Career/resume_view/".$t_id;?>" 
                                      		class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-view-list"></i></a>  
  											<a  title="Delete" href="<?php echo base_url()."Career/delete_job_application/".$t_id;?>" 
