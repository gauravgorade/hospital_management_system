...
<head>
    ...
    <title>Gallery Category For Endovascular </title>
...
<?php   $this->load->view('admin/file/header')?>
  ...
  <div class="col-md-12">
  				  <div class="card">
                        <div class="card-body">
                            <h6 class="card-title"> Add   Gallery  Category  For Endovascular</h6>

 <?php  echo form_open_multipart('gallery_category2/creting_gallery_category' ,'class="needs-validation" novalidate'); ?>
...
<?php  echo form_close();?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title"> Gallery Category For Endovascular </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->gc_name; ?></td>
                                         ...
                                         <th><a href="<?php echo base_url()."gallery_category2/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."gallery_category2/delete_gallery/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."gallery_category2/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."gallery_category2/status/".$t_id."/1";?>">
