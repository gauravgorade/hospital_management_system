            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>review/view_review">View Review</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Review of Jaju Clinic</h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <th align="center">  <figure class="avatar avatar-sm">
											<img src="<?php echo  base_url()."public/img/client/".$row->img_path;?>" class="rounded-circle" alt="R">  </figure>
                                         </th>
                                        <td> <?php echo $row->full_name; ?></td>
                                        <td> <?php echo substr($row->thought,0,10); ?></td>
                                        <td> <?php echo $row->c_desc; ?></td>
                                       
                                      <th><a href="<?php echo base_url()."review/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."review/delete_review/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."review/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."review/status/".$t_id."/1";?>">
