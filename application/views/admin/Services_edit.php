        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Services/view"> Location View</a>
                    </li>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Update  Location </h6>
   ...
   <div class="form-row">
      <div class="col-md-6 mb-3">
        ...
        <input type="hidden"   name="url" value="<?php echo base_url().$this->uri->uri_string();?>">
         ...
         <label for="s_name"> Location Name</label>
         ...
         <div class="invalid-tooltip">   Please Enter  Location Name.  </div>
      </div>
      <div class="col-md-6 mb-3">
         <label for="service_url"> Location Url</label>
