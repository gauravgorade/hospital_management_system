            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>Clients/view_Clients">View Clients</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title"> Our Clients </h6>
                            <div class="table-responsive">
                                 ...
                                 <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->s_id;  $status = $row->status;  ?>
				 			    <tr>
                                        
                                        
                                        <th align="center">   
											<img height="100px;" src="<?php echo  base_url()."public/img/client/".$row->img_path;?>"  alt="image">   
                                         </th>
                                        <td> <?php echo $row->cname; ?></td>
                                         <th><a href="<?php echo base_url()."Clients/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."Clients/delete_Clients/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Clients/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Clients/status/".$t_id."/1";?>">
