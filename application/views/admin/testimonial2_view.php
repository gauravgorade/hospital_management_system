...
<head>
    ...
    <title>Testimonial For Endovascular </title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Testimonial  For Endovascular  </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>testimonial2/view_testimonial2">View Testimonial</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Testimonial Or Success story  For Endovascular </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo substr($row->thought,0,10); ?></td>
                                        <td> <?php echo $row->c_desc; ?></td>
                                       
                                      <th><a href="<?php echo base_url()."testimonial2/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."testimonial2/delete_testimonial2/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."testimonial2/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."testimonial2/status/".$t_id."/1";?>">
