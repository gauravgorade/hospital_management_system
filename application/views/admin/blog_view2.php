...
<head>
    ...
    <title>Endovascular  Blogs</title>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>blogs2/view">Endovascular   Blogs</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">View Endovascular   Blogs  </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->blog_name; ?></td>
										  ...
										  <td> <a href="<?php echo base_url()."blogs2/comment/".$t_id;?>" type="button" class="btn btn-primary btn-sm  position-relative"> 
											CMNT (<?php    $query = $this->db->query("SELECT * FROM blog_camment2 where blog_id='$t_id'  AND status='1'" );
												echo $query->num_rows(); ?>)
										     <span class="badge bg-danger ms-2">
												NEW <?php  	$query = $this->db->query("SELECT * FROM blog_camment2 where blog_id='$t_id'" );
												echo $query->num_rows(); 	?>
											 </span> </a>
											  
									  </td>
                                         <th class="text-center"><a href="<?php echo base_url()."blogs2/edit/".$t_id;?>" class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."blogs2/delete/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 

											  
  										</th>
  										   <td class="text-center"> <?php  $featured = $row->featured;
										 if($featured == "on"){ echo '<span class="badge badge-success">Yes</span></a>';	}
											 ?></td>
										  
  									    <td class="text-center">
                                             <?php   if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."blogs2/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Published</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."blogs2/status/".$t_id."/1";?>">
                   						   <span class="badge badge-danger">Pedning  </span></a>  
                   							   <?php }?>
               								 </td>
