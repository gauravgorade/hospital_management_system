...
<head>
    ...
    <title>View Skin Blog Tag </title>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <a href="<?php echo base_url();?>Blogs/view_blog_tag">View  Skin Blog Category</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Add Skin Blog Tag</h6>
                                            <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->


                                            <?php  echo form_open_multipart('Blogs/creating_blog_tag' ,'class="needs-validation" novalidate'); ?>

                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="fullname">Tag Name</label>
                                                    <input name="tagname" id="tagname" type="text" class="form-control"
                                                        onload="convertToSlug(this.value)"  onkeyup="convertToSlug(this.value)" 
														 value="<?php echo set_value('tagname'); ?>" required >
                                                    <div class="invalid-tooltip"> Please Enter Tag Name. </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="fullname">Tag Url</label>required
                                                    <input name="tagurl" id="tagurl" type="text" class="form-control"
                                                     	 value="<?php echo set_value('tagurl'); ?>"   required  >
                                                    <div class="invalid-tooltip"> Please Enter Tag Url. </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="fullname">Tag Description</label>
                                                    <textarea name="cat_desc" id="cat_desc" class="form-control"  required  > <?php echo set_value('cat_desc'); ?></textarea>
                                                    <code> It Helps to seo Tag wise blog showing in serch result</code>
                                                    <div class="invalid-tooltip"> Please Enter Tag Description </div>
                                                </div>
                                            </div> <br>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Skin Blog Tags</h6>
                                 ...
                                 $i=0;
                                    	foreach ($result as $row) {  
                                    	 $i++;
                                    	 $t_id = $row->b_tag_id;  $status = $row->b_tag_status; 
                                    	    ...
                                    	    ?>
                                                        <tr>
                                                            ...
                                                            <td> <?php echo $row->b_tag_name; ?></td>
                                                            <td> <?php echo $row->b_tag_url; ?></td>
                                                            <th  width="8%" class="text-center"><a href="<?php echo base_url()."Blogs/edit_blog_tag/".$t_id;?>"
                                                                    class="btn btn-primary btn-floating btn-sm">
                                                                    <i class="ti-pencil-alt"></i></a>
                                                                <a href="<?php echo base_url()."Blogs/delete_blogtag/".$t_id;?>"
                                                            ...
                                                            <td  width="5%">
                                                                <?php if ($status == 1){ ?>
                                                                <a
                                                                    href="<?php echo base_url()."Blogs/blogtag_status/".$t_id."/0"?>">
                                                                    <span class="badge badge-success">Active</span></a>
                                                                <?php } else {?>
                                                                <a
                                                                    href="<?php echo base_url()."Blogs/blogtag_status/".$t_id."/1";?>">
