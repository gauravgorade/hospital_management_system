                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url();?>blogs/view_blog_categories">Skin  Category View</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Skin  Blog Category Update</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Update Skin  Blog Category</h6>
