...
<html lang="en">
 <head>
    ...
    <title> Endovascular Blog Tag</title>
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Blogs2/view_blog_tag">Endovascular Blog Tag View</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"> Endovascular Blog Tag Update</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Update Endovascular Blog Tag</h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('Blogs2/update_blog_tag' ,'class="needs-validation" novalidate'); ?>
