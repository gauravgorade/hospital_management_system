            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>Customer/view_customer">View Customer</a>
                    </li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="table-responsive">
                                 ...
                                 <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->cli_id;  $status = $row->status;  ?>
				 			    <tr>
                                        ...
                                        <td> <?php echo substr($row->address,0,20);?></td>
                                      <th><a href="<?php echo base_url()."Customer/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."Customer/delete_Customer/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Customer/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Customer/status/".$t_id."/1";?>">
