 ...
 ?>            
   ...
   <div class="form-row">
      ...
      <div class="col-md-12 d-none">
         <label for="paragraph1">Slider Paragraph</label>
       ...
       <div class="col-md-6 d-none" >
         <label for="button_link1">Slider button Name </label>
      ...
      <div class="row">
       <div class="col-md-8">
       <label for="userImage">Select Slider Image <code>width=1400;  and  Height=550px Max Image Size 2MB 
 		 	   </code></label>
