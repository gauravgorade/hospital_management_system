...
<html lang="en">
 <head>
    ...
    <title> Edit Skin Blog Tag</title>
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Blogs/view_blog_tag">Blog Skin Tag View</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page"> Blog Skin Tag Update</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Update Skin Blog Tag</h6>
