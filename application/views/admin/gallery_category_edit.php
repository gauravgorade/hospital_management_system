...
<html lang="en">
 <head>
    ...
    <title> Skin Category Gallery</title>
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Gallery_category/view_gallerycategory">Skin Gallery Category View</a>
                
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Skin Gallery Category Update</li>
                </ol>
            </nav>
        </div>
    </div>
 ...
 <div class="col-md-12">
  <div class="row">
     <div class="col-md-12">
        <div class="card">
           <div class="card-body">
<h6 class="card-title">Skin Update Gallery Category</h6>
 <!--  <P>If your form layout  <code>.{valid|invalid}-feedback</code>  .</P> -->
 

 <?php  echo form_open_multipart('Gallery_category/update_gallery_category' ,'class="needs-validation" novalidate'); ?>
