...
<head>
    ...
    <title>Job Application full details</title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Job Application full details</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>Career/view_application"> 
                   		 Job Application List </a>
                    </li>
                    <li class="breadcrumb-item active">
                        <a href="#"> 
                     Full Details </a>
                    ...
                    <div>
                      <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->appy_id;  $status = $row->status;
                                    	    ?>
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                             ...
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <div class="col-md-10 col-12">
                                    <h3 class="text-info mb-0 float-right"><?php echo $row->bio; ?></h3>
                                </div>
                            </div>
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                                    <h5>Resume Dounload</h5>
                                     
                                </div>
                                <div class="col-md-10 col-12">
                                    <h3 class="text-secondary mb-0 float-right"> <a class="text-secondary" href="<?php echo base_url()."public/resume_doc/".$row->resume_path;?>"> Download Now</a> </h3>
                                </div>
                            </div>
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
