...
<head>
    ...
    <title> JAJU – Endovascular  Skin Blog Details | Hospital and Health </title>
                        ...
                        <div class="breadcrumb-wrap text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Endovascular  Blog</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                        ...
                        <div class="blog-details-wrap">
                            ...
                            <div class="meta__info">
                                <ul>
									...
									<?php 
								$blog_id= $row->blog_id;
										 $comment_query = $this->db->query("SELECT * FROM `blog_camment2` 
                           		 where blog_id='$blog_id' AND status='1' ORDER BY `blog_camment2`.`cmt_id` DESC");
                                ...
                                <div class="row">
                                            ...
                                            <ul>
												  <?php foreach ($tag_result as $prow) 
														{     $gc_id=  $prow->b_tag_id;  	$tag_url =$prow->b_tag_url; 
																	...
																	{	?>
                                               				        <li><a href="<?= base_url("endovascular-tag/".$tag_url)?>"><?= ucfirst($service_nm)?></a></li>
													 <?php 	} }?>
                                            </ul>
								        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-5 pt-35">
                                        <div class="post__share ">
                                            <h5>Social Share <?php //echo $bg_url_encode=  urlencode($row->blog_name) ;?></h5>
                                            <ul>
                            ...
                            <div class="posts_navigation pt-35 pb-35">
								...
								<?php 
                                       $blog_id  =  $row->blog_id; 
                                      $query = $this->db->query("SELECT * FROM blog_tbl2 WHERE blog_id < '$blog_id' ORDER BY blog_id LIMIT 1");
                                    ...
                                    <div class="col-xl-4 col-md-5">
                                        <div class="prev-link">
                                            <span>Prev Post</span>
                                            <h4><a href="<?= base_url()."endovascular-blog/".$rows['blog_url'];?>" > <?php  echo $rows['blog_name'] ?> </a></h4>
                                        </div>
                                    </div>
									<?php } 
                                      $blog_id  =  $row->blog_id; 
                                      $query2 = $this->db->query("SELECT * FROM blog_tbl2 WHERE blog_id > '$blog_id' ORDER BY blog_id LIMIT 1");
                                ...
                                <?php 
                                    ...
                                    <div class="col-xl-4 col-md-5">
                                        <div class="next-link text-left text-md-right">
                                            <span>Next Post</span>
                                            <h4><a href="<?= base_url()."endovascular-blog/".$rowsd['blog_url']; ?>"> <?= $rowsd['blog_name'];?></a></h4>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="related__post mt-45 mb-85">
                                ...
                                <div class="row">
											...
											<?php  
										 $res= 	$this->Blog_model2->get_recent_blog_catigiery_wise($category_id);
                            ...
                            <div class="avatar__wrap text-center mb-45">
                                ...
                                <div class="avatar__info">
                                    ...
                                    <div class="avatar__info-social">
                                        ...
                                        <a href="https://www.instagram.com/jajuendovascularclinic/"><i class="fab fa-instagram"></i></a>

                                        <a href="javascript:void(0);"><i class="fab fa-twitter"></i></a>
                                        <a href="https://www.google.com/maps/place/Jaju+Clinic/@19.859294,75.347471,14z/data=!4m5!3m4!1s0x0:0x52e59df451bc8466!8m2!3d19.8592556!4d75.3474678?hl=en">
				...
				/*   AND status ='0'  */  
					 $public_ip=  $this->input->ip_address();    $message="";
							 $comment_query = $this->db->query("SELECT * FROM `blog_camment2` 
                            where blog_id='$blog_id' ORDER BY `blog_camment2`.`cmt_id` DESC");
                            ...
                            <form action="<?= base_url()?>endovascular_blog/blog_comment" class="comment__form needs-validation" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate>
                        ...
                        <aside>
                            ...
                            <div class="widget mb-40">
                                ...
                                <div class="widget-social text-center">
                                    <a href="https://www.facebook.com/jajuendovascularclinic"><i class="fab fa-facebook-f"></i></a>
									 <a href="https://www.instagram.com/jajuendovascularclinic/"><i class="fab fa-instagram"></i></a>
                                     <a href="https://www.google.com/maps/place/Jaju+Clinic/@19.859294,75.347471,14z/data=!4m5!3m4!1s0x0:0x52e59df451bc8466!8m2!3d19.8592556!4d75.3474678?hl=en">
									 <i class="fal fa-map-marker-alt"></i></a>
                                    <a href="javascript:void(0);"><i class="fab fa-twitter"></i></a>
                                    ...
                                    <ul>
 									 ...
 									 <li>
                                            ...
                                            <div class="widget__post-content">
                                                <h6><a href="<?php echo base_url()."endovascular-blog/".$blog_url;?>"> <?php  
