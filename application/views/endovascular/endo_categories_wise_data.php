...
<head>
    ...
    <title> <?=  $crows->b_cat_name;?> JAJU – endovascular Blog | Hospital and Health </title>
                        ...
                        <div class="breadcrumb-wrap text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Endovascular Categories</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post mb-30" >
                                <div class="blog-thumb">
                                    <a href="<?php echo base_url()."endovascular-blog/".$blogname;?>">
                                ...
                                <div class="blog-content text-center">     
                                     <h4><a href="<?php echo base_url()."endovascular-blog/".$blogname;?>"> <?php echo $row->blog_name; ?> </a> </h4>
 									<p style="text-align: justify;"> 
 									<?php  $short_info = $row->short_desc; echo  substr_replace($short_info , "...", 110);?></p>     
                                     </p>    
                                   	 	 <div class="blog-btn"><a href="<?php echo base_url()."endovascular-blog/".$blogname;?>">
