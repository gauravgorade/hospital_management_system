                    ...
                    <div class="col-lg-8">
                        <div class="bsingle__post mb-50">
                            ...
                            <div class="bsingle__content">
                                ...
                                <h2><a href="<?php echo $domain;?>skin/blogDetails.php">Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__post-thumb video-p">
                                <img src="<?php echo $domain;?>public/img/blog/inner_b2.jpg" alt="">
                            ...
                            <div class="bsingle__content">
                                ...
                                <h2><a href="<?php echo $domain;?>skin/blogDetails.php">There are many variations passages of like consectetur
                                        lorem ipsum available.</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt
                                    ut labore et dolore magna
                                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                        ...
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__post-thumb blog-active">
                                <div class="slide-post">
                                    <img src="<?php echo $domain;?>public/img/blog/inner_b3.jpg" alt="">
                                </div>
                                <div class="slide-post">
                                    <img src="<?php echo $domain;?>public/img/blog/inner_b2.jpg" alt="">
                                </div>
                            ...
                            <div class="bsingle__content">
                                ...
                                <h2><a href="<?php echo $domain;?>skin/blogDetails.php">I must explain to you how all this mistaken idea of
                                        denouncing pleasure.</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt
                                    ut labore et dolore magna
                                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                        ...
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__content">
                                ...
                                <h2><a href="<?php echo $domain;?>skin/blogDetails.php">On the other hand, we denounce with of righteous
                                        indignation and dislike men.</a></h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt
                                    ut labore et
                                    dolore magna
                        ...
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__content quote-post" style="background-image:url(img/bg/quote_bg.png)">
                                ...
                                <div class="quote-icon">
                                    <img src="<?php echo $domain;?>public/img/icon/blockquote.png" alt="">
                                </div>
                                <h2><a href="<?php echo $domain;?>skin/blogDetails.php">We denounce with of righteous one indignation and
                                        dislike men.</a></h2>
                            </div>
                        </div>
