...
<?php   $this->load->view('layout/style');?>
    ...
    <title> JAJU – Acne Scar Management | Hospital and Health </title>
...
<?php   $this->load->view('layout/header2');   ?>
    <main>
        ...
        <section class="breadcrumb-area d-flex align-items-center"
            style="background-image:url(<?php echo base_url(); ?>public/jaju/picture/bread/acer.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="breadcrumb-wrap text-center">
                            <div class="breadcrumb-title mb-30">
                                <h2 class="fs-24">Acne Scar Management</h2>
                            </div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>skin">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">Acne Scar Management</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="p-relative">
                            <img src="<?php echo base_url(); ?>public/jaju/picture/skin/acnescar.png" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="about-content s-about-content pl-30">
                            <div class="section-title mb-20">
                                <span>Acne Scar Management</span>
                                <h2>Experience a More Beautiful You.</h2>
                            </div>
                            <p>The goal of Acne Scar Management is to improve a person's appearance,
