...
<body>
    ...
    <main>
        <section class="breadcrumb-area d-flex align-items-center"
            style="background-image:url(../public/picture/bread/skingeneral2.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="breadcrumb-wrap text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo $domain;?>skin/skin.php">Home</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="blog-details-wrap">
                            <div class="bsingle__post-thumb mb-30">
                                <img src="<?php echo $domain;?>public/img/blog/inner_b1.jpg" alt="">
                            </div>
                            ...
                            <div class="details__content pb-50">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    ...
                                    officia deser unt
                                    mollit anim id est
                                    laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant ium
                                    doloremque
                                    laudantium, totam rem
                                    aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae
                                    vitae dicta sunt
                                    explicabo. Nemo enim
                                    ipsam voluptatem quia voluptas sit asperna tur aut odit aut fugit, sed quia
                                ...
                                <blockquote>
                                    ...
                                    incididunt
                                    with ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                    exercitation a deef
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    ...
                                    officia deser unt
                                    mollit anim id est
                                    laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusant.
                                </p>
                                <div class="details__content-img">
                                    <img src="<?php echo $domain;?>public/img/blog/b_details01.jpg" alt="">
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                    incididunt
                                    ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                                    ...
                                    officia deser unt
                                    mollit anim id est
                                    laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusan tium
                                    doloremque
                                    laudantium, totam rem
                                    aperiam, eaque ipsa quae ab illo inventore veritatis et quasi archi tecto beatae
                                    vitae dicta sunt
                                    explicabo. Nemo enim
                                    ipsam voluptatem quia voluptas sit asperna tur aut odit aut fugit, sed quia
                                    consequuntur magni dolores
                                    ...
                                    dolor sit amet,
                                    consectetur,
                                    adipisci velit, sed quia non num quam eius modi tempora incidunt ut labore et dolore
                                    magnam aliquam
                                    quaerat voluptatem.
                                    Lorem ipsum dolor sit amet,consectetur adipisicing elit, sed do eiusmod incididunt.
                                </p>
                                <figure>
                                    <img src="<?php echo $domain;?>public/img/blog/b_details02.jpg" alt="">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                                        incididunt ut labore
                                        et dolore magna
                                        ali qua. Ut enim ad minim veniam, quis nostrud exercitation ulla mco laboris
                                        nisi ut aliquip ex ea
                                        commodo consequat.
                                        Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
                                        fugiat nulla
                                        pariatur. Excepteur sint
                                        occaecat cupida tat non proident, sunt in culpa qui officia deserunt mollit anim
                                        id est laborum. Sed
                                        ut perspiciatis
                            ...
                            <div class="posts_navigation pt-35 pb-35">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-4 col-md-2 text-left text-md-center">
                                        <a href="blog.html" class="blog-filter"><img src="<?php echo $domain;?>public/img/icon/c_d01.png"
                                                alt=""></a>
                                    </div>
                                    <div class="col-xl-4 col-md-5">
                            ...
                            <div class="related__post mt-45 mb-85">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="related-post-wrap mb-30">
                                            <div class="post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/b_details03.jpg" alt="">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="related-post-wrap mb-30">
                                            <div class="post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/b_details04.jpg" alt="">
                                            </div>
                                            <div class="rp__content">
                            ...
                            <div class="avatar__wrap text-center mb-45">
                                <div class="avatar-img">
                                    <img src="<?php echo $domain;?>public/img/blog/comment/avatar.png" alt="">
                                </div>
                            ...
                            <div class="comment__wrap pb-45 mb-45">
                                ...
                                <div class="single__comment mb-35">
                                    <div class="comments-avatar">
                                        <img src="<?php echo $domain;?>public/img/blog/comment/c_01.png" alt="">
                                    </div>
                                ...
                                <div class="single__comment children mb-35">
                                    <div class="comments-avatar">
                                        <img src="<?php echo $domain;?>public/img/blog/comment/c_02.png" alt="">
                                    </div>
                                    <div class="comment-text">
                                        <div class="avatar-name mb-15">
                                ...
                                <div class="single__comment">
                                    <div class="comments-avatar">
                                        <img src="<?php echo $domain;?>public/img/blog/comment/c_03.png" alt="">
                                    </div>
                                    <div class="comment-text">
                                        <div class="avatar-name mb-15">
                                            <h6>Roboto Alex</h6>
                        ...
                        <aside>
                            ...
                            <div class="widget mb-40">
                                ...
                                <ul class="widget-insta-post">
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_01.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_02.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_03.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_04.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_05.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_06.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_07.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_08.jpg" alt="img"></a></li>
                                    <li><a href="#"><img src="<?php echo $domain;?>public/img/blog/aside/insta_09.jpg" alt="img"></a></li>
                                </ul>
                            </div>
                            <div class="widget mb-40">
                                <div class="widget-title text-center">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="widget__post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/aside/post_01.jpg" alt="">
                                            </div>
                                        ...
                                        <li>
                                            <div class="widget__post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/aside/post_02.jpg" alt="">
                                            </div>
                                            <div class="widget__post-content">
                                        ...
                                        <li>
                                            <div class="widget__post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/aside/post_03.jpg" alt="">
                                            </div>
                                            <div class="widget__post-content">
                                        ...
                                        <li>
                                            <div class="widget__post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/aside/post_04.jpg" alt="">
                                            </div>
                                            <div class="widget__post-content">
                                        ...
                                        <li>
                                            <div class="widget__post-thumb">
                                                <img src="<?php echo $domain;?>public/img/blog/aside/post_05.jpg" alt="">
                                            </div>
                                            <div class="widget__post-content">
