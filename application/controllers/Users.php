...
class Users extends CI_Controller
{
    ...
    public function add_user()
    {
        ...
        if ($session_id == true)
        {
 		 ...
 		 $admin_role = test_input($this->input->post('admin_role'));
  		  $admin_def_role = test_input($this->input->post('admin_def_role'));
            ...
            $data = array('name' => $name,
				...
				'admin_role'=> $admin_role,'admin_role_default'=> $admin_def_role ,
