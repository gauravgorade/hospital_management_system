...
class Gallery_category extends CI_Controller
{
    ...
    public function view_gallerycategory()
    {
        ...
        if($session_id==true)
        {
            ...
            $data['result_ca']=$this->gallery_model->get_gallerycategory();
            $this->load->view("admin/gallery_category", $data);
         } else
        {
    ...
    public function add_gallerycategory()
    {
        ...
        if($session_id==true)
        {
            ...
            $this->load->view('admin/gallerycategory_add');
    ...
    public function status($t_id,$status)
    {
        ...
        if ($session_id == true)
        {
            ...
            $this->gallery_model->category_update_data($data,$t_id);
            $this->session->set_flashdata('success','gallery Status Change   Successfully!');
            redirect(base_url(). 'Gallery_category/view_gallerycategory');
    ...
    public function edit($t_id)
    {
        ...
        { 
            ...
            $data['result'] = $this->gallery_model->Category_get_single_data($t_id);
            $this->load->view('admin/gallery_category_edit', $data);
    ...
    public function delete_gallery($t_id)
    {
        ...
        if ($session_id == true)
        {
            ...
            $this->gallery_model->delete_category_id($t_id);
    ...
    public function creting_gallery_category()
    {
        ...
        if ($session_id == true)
        {
            ...
            if (isset($_POST['s_name']))
            {
                ...
                $this->gallery_model->insert_category_data($data);
