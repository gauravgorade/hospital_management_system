  ...
  class Get_quote_model extends CI_Model
{
    ...
    public function get_quote_admin($name,$email,$mobile,$age,$service,$message,$bookingdate,$bookingtime)
    {
        ...
        foreach ($query->result() as $row)
        {
            ...
            $query2 = $this->db->query("SELECT * FROM `maling_list` WHERE m_id='6'");
...
<table class=" main contenttable" align="center" style="font-weight: normal;border-collapse: collapse;border: 0;margin-left: auto;margin-right: auto;padding: 0;font-family: Arial, sans-serif;color: #555559;background-color: white;font-size: 16px;line-height: 26px;width: 600px;">
							...
							<table style="width: 100%;  font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										Dear Admin,<br><br>
                                            Appointment Booking Requested by.
                                            <br> Name : '.$name.'
                                            <br> Email  : '.$email.'
                                            ...
                                            <br> Service  : '.$service.'
                                            <br> Comment  : '.$message.'
                                            <br> Appointment Date & time  : '.$bookingdate.'- '.$bookingtime  .'
    ...
    public function get_quote_user($name,$email)
    {
      
        $date=date('d-m-Y H:i:s');
        $weekday=date('l', strtotime( $date));
        $month = date('M', strtotime($date));   $year = date('d, Y');
        $time = date('h:i:s a', strtotime($date));
						...
						<td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
							<table style="width: 100%;  font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										Dear '.$name.',<br><br>
                                             Your appointment request was reviewed by us.<br>
                                               We will revert you shortly.
                                           <br> <br> <br> Thank you for appointment request
                                           <br> '.$website_name.'
